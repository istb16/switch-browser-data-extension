      ...
      delReq.onsuccess = () => {
        ...
        req.onsuccess = async (e) => {
          ...
          try {
            ...
            // store.add() can throw synchronously (e.g. DataError when a
            // record is missing its declared keyPath); without this catch
            // that throw is swallowed by the async handler and the promise
            // never settles.
            db.close();
            reject(err);
          }
